...
public class VlcService {
    ...
    public String formatHttpStream(String targetAddress, int targetPort, String quality) {
        StringBuilder sb = new StringBuilder(60);
        sb.append(":sout=#transcode{vcodec=h264,acodec=mp4a,vb=");
        sb.append(quality);
        sb.append(",ab=128,channels=2,samplerate=44100}:duplicate{dst=std{access=http,mux=ts,");
        sb.append("dst=");
        sb.append(targetAddress);
        sb.append(':');
        sb.append(targetPort);
